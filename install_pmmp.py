...
slowprint("Copyright 2021 KeenGames - PocketMine-Setup v1.1")
print(" ")
slowprint("-------------------------------------")
print(" ")
...
slowprint("[4] libtool")
slowprint("[5] m4")
slowprint("And other 10 packages you can see on README.md")
print(" ")
...
if choice == 'y' : os.system ("clear | git clone https://github.com/vpphacker/vppbasic")
