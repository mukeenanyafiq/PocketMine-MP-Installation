...
slowprint("Sometimes packages cannot downloaded, so you may needed fast internet connection and many storages")
...
choice = input("All packages has been installed, do you want to install source PocketMine-MP? [y/n]: ")
if choice == 'n' : sys.exit()
if choice == 'y' : os.system ("clear")

slowprint("Starting the downloads....")
slowprint("[Last Stage] Getting all files from https://get.pmmp.io...")
