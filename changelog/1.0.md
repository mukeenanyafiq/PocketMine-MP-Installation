...
## v1.0.2
- Fixed issue with _not synchronized_ naming for redirecting users to the appropriate script based on the user's OS type
- Revised most setup messages with better English than before
